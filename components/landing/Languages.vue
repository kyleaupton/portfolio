...
export default defineComponent({
  ...
  computed: {
    ...
    frameworks(): DataRecord[] {
      return [
        { i: 0, language: "React", percentage: 50, color: "#61DBFB" },
        {
          i: 1,
          language: "Express",
          percentage: 50,
        ...
        { i: 2, language: "Tailwind", percentage: 60, color: "#06b6d4" },
        { i: 3, language: "Nuxt", percentage: 80, color: "#42b883" },
        {
          i: 4,
          language: "Fastify",
          percentage: 100,
        ...
        { i: 5, language: "Electron", percentage: 100, color: "#0881d1" },
        { i: 6, language: "Vue", percentage: 100, color: "#42b883" },
      ];
    },
  },
